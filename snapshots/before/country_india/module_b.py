...
IN = os.path.join("..","shared","module_a_output_india.csv")
OUT = os.path.join("..","shared","module_b_output_india.csv")
...
if insert_after in orig_header:
    ...
    idx = len(orig_header)
new_header = orig_header[:idx] + orig_header[idx:]
...
print("Module B: read", IN, "and wrote", OUT)
