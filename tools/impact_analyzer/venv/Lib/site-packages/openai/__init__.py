...
class _ModuleClient(OpenAI):
    ...
    @override
    def A_KY(self) -> str | None:
        return A_KY

    @A_KY.setter  # type: ignore
    def A_KY(self, value: str | None) -> None:  # type: ignore
        global A_KY
...
def _has_openai_credentials() -> bool:
    return _os.environ.get("OP_A_KY") is not None


def _has_azure_credentials() -> bool:
    return azure_endpoint is not None or _os.environ.get("AZURE_OP_A_KY") is not None
